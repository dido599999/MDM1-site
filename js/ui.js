// js/ui.js — واجهة المستخدم والتفاعلات
...
var chatReplies = {
  ...
  'شريعة':    'MDM1 متوافق مع الشريعة. راجع الأكاديمية الشرعية للتفاصيل.',
  'سعر':      'السعر قيد التحديث فور الإدراج الرسمي.',
  'polygon':  'MDM1 على Polygon POS — سريعة وذات رسوم منخفضة.',
  'مشاركة':  'نظام المشاركة يطلق في المرحلة الثانية — عائد تقديري 15.4%.',
  'تداول':    'تداول MDM1 عبر QuickSwap. رابط التداول في صفحة HUB.',
};
function sendMsg() {
  ...
  setTimeout(function() {
    ...
    var rep = 'شكراً لسؤالك. تصفح مكتبة MDM1 أو انضم لمجتمعنا على تيليجرام.';
